...
import { X, PlusCircle, CheckCircle2, Zap } from 'lucide-vue-next';
    ...
    >
      ...
      <form @submit.prevent="handleSubmit" class="space-y-4">
        ...
        <div>
          ...
          <div class="space-y-2">
            <label
              ...
              :key="opt"
              class="flex items-center gap-2 p-2.5 rounded-md border border-border-default bg-bg-subdued text-xs text-text-primary cursor-pointer hover:bg-border-default"
            >
              <input
                type="radio"
                name="socket"
        ...
        <button
          ...
          class="w-full h-11 rounded-md bg-primary hover:bg-primary-hover text-on-primary font-medium text-xs flex items-center justify-center gap-2 mt-2 focus-visible:outline-none"
        >
          <Zap class="w-4 h-4" />
