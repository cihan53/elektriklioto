# Studio Yetkilisi Çözüm Planı: TALEP-006

> **Talep:** [TALEP-006] Konum izni verildiğinde kullanıcının anlık konumunu gösteren mavi nokta/baloncuk eksik  
...
- [ ] İlgili ekranda (`/harita`) görsel veya işlevsel bir kırılma yaşanmadı.
